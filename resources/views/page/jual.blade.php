...
<div class="page-top-info">
    <div class="container">
        <h4>Tambah Iklan Jual Barang Bekas</h4>
                    ...
                    <form class="checkout-form" id="tambahin" method="POST" action="{{url('jual/tambah')}}">
                        ...
                        <div class="row contact-form">
							<div class="col-md-12">
								...
								<textarea name="desc" placeholder="Deskripsi"></textarea>
							</div>
							<div class="col-md-6">
                    ...
                    success: function(data){
                        if(data == "sukses"){
                            ...
                            $dropZone[0].dropzone.processQueue();
                                swal.fire('Berhasil Tambah Iklan!',
                                            'Data iklan telah ditambahkan !',
                                            'success').then(function(){ 
                                                     location.reload();
                                            });
                        }else {
                            console.log(data);
                          swal.fire('Gagal Tambah Iklan !', 'Terjadi Error', 'error');
                        }
                    }
                });
