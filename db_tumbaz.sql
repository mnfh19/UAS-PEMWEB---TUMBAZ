...
,`tgl_post_barang` date
);

-- --------------------------------------------------------

--
-- Stand-in structure for view `q_jual`
-- (See below for the actual view)
--
CREATE TABLE `q_jual` (
`id_barang` int(11)
...
,`no_telp` varchar(50)
,`tgl_daftar` date
,`gambar_profile` varchar(100)
);

-- --------------------------------------------------------

--
-- Stand-in structure for view `q_sewa`
-- (See below for the actual view)
--
CREATE TABLE `q_sewa` (
`id_sewa` int(11)
...
,`fasilitas_sewa` text
,`syarat_sewa` text
,`tipe_sewa` varchar(100)
,`kategori_sewa` varchar(100)
,`subkategori_sewa` varchar(100)
,`status_sewa` int(11)
,`provinsi` varchar(255)
,`kabupaten` varchar(255)
,`kecamatan` varchar(255)
...
INSERT INTO `tbl_admin` (`id_admin`, `username`, `pass`) VALUES
(1, 'Nopal', 'nopal');
...
INSERT INTO `tbl_barang` (`id_barang`, `id_user`, `tipe_barang`, `nama_barang`, `desc_barang`, `tgl_post_barang`, `status_barang`) VALUES
(17, 1, 'Mobil', 'Honda Jazz RS AT 2010 KM rendah', 'honda jazz rs at 2010\r\ntangan pertama\r\nkondisi full modifikasi\r\njok kulit mbtech\r\nvelg + ban 90%\r\njarang pakai(KM37rb)\r\nbukan bekas banjir / tabrakan\r\nnego', '2020-05-18', 0),
(21, 1, 'Mobil', 'Lamborghini Aventador S', 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Maecenas orci est, vulputate eu hendrerit eu, placerat interdum nulla. Quisque non malesuada magna. Etiam tincidunt est vitae diam euismod, et aliquam mauris gravida. Suspendisse venenatis tortor vel purus imperdiet luctus. Phasellus blandit at ligula non ultrices. Sed maximus elit vehicula nisl egestas fermentum. Fusce eu dui ipsum. Morbi at magna sit amet elit vestibulum viverra. Sed ultrices pellentesque nibh, at malesuada magna ornare in. Nam imperdiet facilisis arcu, ut interdum neque mollis ut.', '2020-05-18', 0),
(22, 1, 'Mobil', 'Honda Brio E Satya 2017', 'Mau Jual Mobil Milik Pribadi\r\n\r\nHonda Brio E Satya Tahun 2017 Manual\r\n\r\nPlat BK Kota\r\n\r\nPajak Panjang. Surat Surat Lengkap\r\n\r\nKunci ada dua.\r\n\r\nKondisi mobil Ori luar dalam.\r\n\r\nMinat hubungi No yg ada di User.\r\n\r\nTanpa Perantara.\r\n\r\nCod Banda Aceh.', '2020-05-18', 0),
(23, 1, 'Motor', 'Dijual yamaha R25 atau Tukar tambah dengan kawasaki Ninja', 'Dijual Yamaha R25 tahun Pembelian 2017 pembuatan 2016 atau Tukar tambah sama Ninja RR standard original\r\n\r\nPajak bulan 2 tahun 2020\r\nPlat hidup tahun 2022\r\nKondisi mulus terawat bro\r\nKilo meter baru 19ribuan jarang pakai motor simpanan\r\nWarna biru favorit\r\nMesin halus standar pabrik\r\nModifikasi\r\nknalpot Racing full system proliner\r\nWinglet\r\nJalu AS Roda\r\nCover Arm\r\nKlakson Redit suara besar kaya mobil\r\nStang jepit\r\n\r\nNB: part ory ngga ada jangan ditanyakan lagi ya\r\nSurat surat lengkap bro\r\nBpkb\r\nStnk\r\nFaktur\r\n\r\nUntuk lebih jelasnya silahkan hubungi di whatsapp atau telfon ya\r\n\r\nChek unit nya langsung lebih mantap, cocok bayar bawa pulang. Liat unit ngga harus beli ko\r\nKalau belum cocok ya tidak apa apa biar silaturahmi\r\n\r\nGratis ngopi dan ngobrol ngobrol terkait unit nya\r\n\r\nUntuk harga murah aja bro tapi bukan barang murahan, jaminan bukan bekas banjir, bisa check langsung ke bengkel resmi\r\n\r\nLokasi: Jl. Raya PuKembangan Blok JJ, Puri indah Kembangan selatan Jakarta Barat 11610\r\n\r\n#jualmotorbekas #jualmotoryamaha #jualmotornmaxbekas #jualnmaxjakarta #jualnmaxmurah #jualnmax #kawasakininja #kawasaki #jualmotorninja #jualmotor #jualmoge #jualkawakininja #jualninjarr #jualninja250 #jualninja250fi #jualninja150r #yamahar25 #R25 #jualmotorR25', '2020-05-18', 0),
(34, 1, 'Mobil', 'Chevrolet Spin LTZ AT 2013 Low KM', 'PERHATIAN PENTING\r\nTIDAK MENGGUNAKAN FITUR CHATUNTUK KOMUNIKASI HANYA MENGGUNAKAN WA DAN TELP SAJA\r\nSILAHKAN KLIK FITUR TELP DI APP\r\n\r\nChevy spin ltz at 2013\r\nLow km\r\nHitam metalik\r\n\r\nKondisi tinggal pake\r\nNo pr\r\nIsi bensin pake deh muterin indonesia\r\nNo dandan\r\nMobil cakep\r\nType paling komplit\r\nAc 3 baris\r\nPajak hidup\r\nB jakarta\r\nTangan 1\r\nHarga termurah\r\n\r\nBLOK M MALL BASEMENT 2 BASEMENT AUTOCAR DEKAT KANTOR PENGELOLA OPEN JAM 9 PAGI SD 8 MALAm\r\n\r\nJAKSEL', '2020-05-18', 0),
(37, 1, 'Elektronik', 'Printer Dot Matric EPSON LX 310', 'Printer Epson LX 310\r\n\r\nKondisi baik bisa jalan normal', '2020-05-19', 0),
(40, 1, 'Elektronik', 'Redmi note 7 4/64', 'Masih mulus tanpa gores sedikitpun\r\n\r\nHp. Casan aja (dus gatau kemana)\r\n\r\nAwett batrenya, kamera ok punya\r\n\r\nDi jual aja\r\n\r\nDeal harga lanjut WA. Cocok angkut gacocok skip\r\n\r\nThanks Olx', '2020-05-20', 0),
(41, 1, 'Furniture', 'Genset 80 KVA BERGARANSI Jogja Bantul Brebes', 'Gensetmania.com sudah dipercaya : Perusahaan Air minum AMANAH, Pembangunan Bandara NYI AGENG SERANG Yogyakarta, dan berbagai event lainnya.\r\n\r\n\r\nGensetmania.com siap mendukung kebutuhan listrik untuk berbagai acara yang tengah anda selenggarakan. Sebagian besar pelanggan kami biasa menyewa genset dengan kapasitas mulai 10 kva - 250 kva. \r\n\r\n\r\nUntuk lama penggunaan gensetpun pun bervariasi mulai Harian, Mingguan, Bulanan atau bahkan 1 Tahun penuh. Untuk lama penyewaan gensetmania.com menyesuaikan dengan kebutuhan pelanggan.', '2020-05-20', 1),
(42, 1, 'Elektronik', 'Laptop HP elitebook 840 G1 core i5 gen 4 ram 8gb hdd 500gb', 'Laptop built up import\r\n\r\nKondisi fisik Mulus 97%\r\nBergaransi\r\nSemua fungsi normal\r\nLayar bersih\r\nBatre awet 2-3 jam\r\nTerinstal windows 10 ( bisa diganti sesuai kebutuhan)\r\nSiap pakai\r\nSiap antar alamat Bandung - Cimahi\r\n\r\nSpesifikasi\r\nProcesor core i5-4300u up to 2,9 Ghz\r\nRam 8gb\r\nHdd 500gb ( bisa diganti ssd )\r\nLayar 14 inci\r\nVga intel hd 4600\r\n\r\nKelengkapan\r\nUnit\r\nAdaptor\r\nTas\r\nMouse', '2020-05-20', 0),
(43, 1, 'Elektronik', 'xiaomiyi', 'Kategori	   : Camera\r\nBerat	   : 800 gram\r\nAsal Barang : Lokal\r\nBrand	   : Xiaomi', '2020-05-20', 1),
(49, 1, 'Elektronik', 'ps3 slim hdd 120gb-500gb New tinggal maen', 'Sale ps3 slim/super slim hdd 120gb-500gb free full game stock ready\r\nKelengkapan tinggal maen saja plus 1 stick wirelles,kabel\" lengkap\r\nReady 120gb,160gb,320gb,500gb\r\nMesin pilihan region japan bukan china mesin segel void sony asli japan\r\n(Terbukti china uang kembali 3x lipat )\r\nMesin adem suhu stabil gk cepet panas\r\n\r\n#support hdd external\r\n#Bergaransi real\r\n#sofware terbaru 4.85\r\n#isi game murah bisa satuan\r\n\r\nMinat inbox\r\nNB : bisa datang bisa jg di antar area badung-denpasar free antar plus pasang', '2020-05-22', 0),
(53, 1, 'Elektronik', 'Nitendo Switch', 'Ini Nitendo Switch Versi Terbaru', '2020-05-22', 0);
...
INSERT INTO `tbl_beli` (`id_beli`, `id_barang`, `harga_beli`, `status_beli`) VALUES
(6, 17, '125.000.000', 0),
(7, 21, '7.000.000.000', 1),
(8, 22, '130.000.000', 1),
(9, 23, '34.500.000', 0),
(13, 27, '750.000', 0),
(14, 28, '750.000', 0),
...
--
-- Table structure for table `tbl_elektronik`
--

CREATE TABLE `tbl_elektronik` (
  `id_elektronik` int(11) NOT NULL,
  `id_barang` int(11) NOT NULL,
  `jenis_elektronik` varchar(255) NOT NULL,
  `tipe_elektronik` varchar(255) DEFAULT NULL,
  `merek_elektronik` varchar(255) DEFAULT NULL,
  `kondisi_elektronik` varchar(255) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Dumping data for table `tbl_elektronik`
--

INSERT INTO `tbl_elektronik` (`id_elektronik`, `id_barang`, `jenis_elektronik`, `tipe_elektronik`, `merek_elektronik`, `kondisi_elektronik`) VALUES
(2, 37, 'Komputer', 'Printer, tinta & Scanner', NULL, 'Bekas'),
(3, 40, 'Handphone', NULL, 'Xiaomi', 'Bekas'),
(4, 42, 'Komputer', 'Laptop', NULL, 'Bekas'),
(6, 49, 'Games & Console', 'Console', NULL, 'Baru'),
(7, 50, 'Elektronik Rumah Tangga', 'Alat Dapur', NULL, 'Baru'),
(8, 51, 'Komputer', 'Proyektor', NULL, 'Bekas'),
(9, 53, 'Games & Console', 'Console', NULL, 'Bekas');

-- --------------------------------------------------------

--
-- Table structure for table `tbl_gambar_list`
--

CREATE TABLE `tbl_gambar_list` (
  `id_gambar_list` int(11) NOT NULL,
  `id_barang` int(11) NOT NULL,
  `nama_gambar` varchar(255) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Dumping data for table `tbl_gambar_list`
--

INSERT INTO `tbl_gambar_list` (`id_gambar_list`, `id_barang`, `nama_gambar`) VALUES
(1, 14, '1589762752672hqdefault.jpg'),
(2, 14, '1589762749538700409469119160037c498df9f4d8141.png'),
(3, 5, '15897627526722017_aventador_s_coupe_22.jpg'),
(4, 5, '158976275267220172194_main_f.jpg'),
(5, 5, '158976275267220172194aventador-syellow066.png'),
(6, 5, '158976275267220172194image-lamborghini-perkenalkan-lamborghini-aventador-s.jpg'),
(9, 17, '1589766339280image1.png'),
(10, 17, '1589766348970image5.png'),
(11, 17, '1589766346338image4.png'),
(12, 17, '1589766341625image2.png'),
(13, 17, '1589766343899image3.png'),
(14, 21, '15897665908882194_main_f.jpg'),
(15, 21, '1589766592563aventador-syellow066.png'),
(16, 21, '1589766595262image-lamborghini-perkenalkan-lamborghini-aventador-s.jpg'),
(17, 21, '15897665890272017_aventador_s_coupe_22.jpg'),
(18, 22, '1589779770267mo4.png'),
(19, 22, '1589779755317mo.png'),
(20, 22, '1589779773711mo5.png'),
(21, 22, '1589779764387mo2.png'),
(22, 22, '1589779767581mo3.png'),
(23, 23, '1589784150513mot4.png'),
(24, 23, '1589784108512mot3.png'),
(25, 23, '1589784136617mot1.png'),
(26, 23, '1589784111461mot2.png'),
(28, 34, '1589796562023chev.png'),
(29, 34, '1589796566114chev3.png'),
(30, 34, '1589796573780chev4.png'),
(31, 35, '1589845171704mot2.png'),
(32, 37, '1589845525869print1.png'),
(33, 37, '1589845528503print2.png'),
(34, 40, '1589945364231hp1.png'),
(35, 40, '1589945370448hp3.png'),
(36, 40, '1589945367106hp2.png'),
(37, 41, '1589945463495genset1.jpeg'),
(38, 41, '1589945466553genset2.jpeg'),
(39, 41, '1589945473869genset4.jpeg'),
(41, 42, '1589953946741lap1.png'),
(42, 42, '1589953952192lap2.png'),
(43, 42, '1589953958427lap3.png'),
(44, 42, '1589953971851lap4.png'),
(45, 42, '1589953975084lap5.png'),
(46, 43, '1589954267492NC03NSNLRH0SL5H591VMBUIOWSABKLIYFG1M347Q.jpg'),
(50, 44, '1590120771774hqdefault.jpg'),
(52, 44, '1590121032253700409469119160037c498df9f4d8141.png'),
(53, 44, '159012105311620Misaki-Okusawa-UODDZ9.png'),
(57, 49, '1590137152540ps.png'),
(58, 50, '1590137266778chev4.png'),
(59, 51, '1590137514273genset3.jpeg'),
(60, 52, '15901486638192017_aventador_s_coupe_22.jpg'),
(61, 53, '1590153875785switch3.png'),
(62, 53, '1590153870918switch.png'),
(63, 53, '1590153880933switch4.png');
...
INSERT INTO `tbl_lokasi` (`id_lokasi`, `id_barang`, `id_provinsi`, `id_kabupaten`, `id_kecamatan`) VALUES
(1, 17, 31, 3171, 3171090),
(2, 21, 35, 3515, 3515170),
(3, 22, 33, 3308, 3308170),
(4, 23, 31, 3174, 3174010),
(5, 27, 32, 3214, 3214011),
(6, 28, 64, 6403, 6403150),
(7, 34, 32, 3202, 3202041),
(8, 36, 36, 3602, 3602120),
(9, 37, 36, 3604, 3604240),
(10, 40, 31, 3174, 3174030),
(11, 41, 34, 3402, 3402150),
(12, 42, 32, 3277, 3277020),
(13, 43, 33, 3375, 3375010),
(16, 46, 17, 1703, 1703080),
(19, 49, 51, 5108, 5108030),
(20, 50, 65, 6501, 6501110),
(21, 51, 62, 6203, 6203150),
(22, 52, 35, 3515, 3515170),
(23, 53, 35, 3578, 3578210);
...
CREATE TABLE `tbl_mobil` (
  ...
  `bahan_mobil` varchar(100) NOT NULL,
  `jarak_mobil` varchar(255) NOT NULL,
  `warna_mobil` varchar(100) NOT NULL,
  `tipe_penjual` varchar(100) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `tbl_mobil` (`id_mobil`, `id_barang`, `merek_mobil`, `tahun_mobil`, `bahan_mobil`, `jarak_mobil`, `warna_mobil`, `tipe_penjual`) VALUES
(1, 13, 'DFSK (Dongfeng Sokon)', '2004', 'Bensin', '75.000-80.000', 'Merah', 'Individu'),
(2, 14, 'Ford', '2001', 'Hybird', '75.000-80.000', 'Merah', 'Individu'),
(5, 17, 'Honda', '2010', 'Bensin', '75.000-80.000', 'Lainnya', 'Individu'),
(6, 21, 'Lamborghini', '2019', 'Hybird', '75.000-80.000', 'Kuning', 'Dealer'),
(7, 22, 'Honda', '2017', 'Bensin', '>300.000', 'Hitam', 'Individu'),
(8, 34, 'Chevrolet', '2013', 'Bensin', '75.000-80.000', 'Hitam', 'Dealer'),
(9, 52, 'BMW', '2007', 'Hybird', '55.000-60.000', 'Silver', 'Individu');
...
CREATE TABLE `tbl_motor` (
  ...
  `tipe_penjual` varchar(255) NOT NULL,
  `jarak_motor` varchar(255) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `tbl_motor` (`id_motor`, `id_barang`, `merek_motor`, `tahun_motor`, `warna_motor`, `tipe_penjual`, `jarak_motor`) VALUES
(1, 23, 'Yamaha', '2016', 'Biru', 'Individu', '10.000-15.000');
...
(5, 2, '2', '24 jam', 'ada'),
(6, 2, '0', '24 jam', 'ada'),
(7, 2, '20.000', '24 jam', 'ada'),
(8, 2, '30.000', '24 jam', 'ada'),
(9, 2, '10.000', 'asd', 'ada'),
(10, 2, '1.000', '1 Per Jam', 'ada'),
(11, 2, '2.000', '2 Per Hari', 'ada'),
(12, 2, '3.900', '4 Per Minggu', 'ada'),
(13, 3, '3.575.000', 'Per 8 Hari', 'Senin - Minggu seharian penuh, Libur Nasional seharian penuh'),
(14, 3, '5.300.000', 'Per 16 Jam', 'Senin - Minggu seharian penuh, Libur Nasional seharian penuh'),
(15, 3, '3.575.000', 'Per 1 Minggu', 'Senin - Minggu seharian penuh, Libur Nasional seharian penuh'),
(16, 3, '5.600.000', 'Per 1 Hari', 'Senin - Minggu seharian penuh, Libur Nasional seharian penuh'),
(17, 4, '50.000', 'Per 1 Hari', 'Penyewaan dari jam 06.00 - 23.00');
...
CREATE TABLE `tbl_sewa` (
  `id_sewa` int(11) NOT NULL,
  `id_barang` int(11) NOT NULL,
  `fasilitas_sewa` text NOT NULL,
  `syarat_sewa` text NOT NULL,
  `tipe_sewa` varchar(100) NOT NULL,
  `kategori_sewa` varchar(100) NOT NULL,
  `subkategori_sewa` varchar(100) NOT NULL,
...
INSERT INTO `tbl_sewa` (`id_sewa`, `id_barang`, `fasilitas_sewa`, `syarat_sewa`, `tipe_sewa`, `kategori_sewa`, `subkategori_sewa`, `status_sewa`) VALUES
(3, 41, 'Tarif Rental Genset di Gensetmania Yogyakarta\r\n(Pemakaian perhari sesuai akad awal, Tarif sudah termasuk Bahan Bakar)\r\n\r\n\r\n10kva            : Rp. 800.000,-\r\n20 kva          : Rp. 950.000, -\r\n25 kva          : Rp. 1.050.000, -\r\n30 kva          : Rp. 1.200.000, -\r\n35 kva          : Rp. 1.350.000, -\r\n45 kva          : Rp. 1.800.000, -\r\n50 kva          : Rp. 2.000.000, -\r\n60 kva          : Rp. 2.500.000, -\r\n70 kva          : Rp. 3.000.000, -\r\n80 kva          : Rp. 3.500.000, -\r\n100 kva        : Rp. 4.000.000, -\r\n150 kva        : Rp. 5.500.000, -\r\n200 kva        : Rp. 7.500.000, -\r\n250 kva        : Rp. 8.500.000, -', 'Bisa sewa Harian, Mingguan dan Bulanan\r\nHarga sudah termasuk : Operator pada saat instalasi, Kabel power 15 s/d 50 meter.\r\nGratis pengantaran di wilayah dalam kota Yogyakarta.\r\nSewa genset ke luar kota dikenakan biaya transport tambahan sesuai dengan jarak.\r\nMaksimal penggunaan genset 8 jam perhari. Jika lebih dari 8 jam akan dikenakan tarif over time per jam 10% dari tarif sewa.\r\nHarga sewa genset untuk stand by sama dengan diatas, apabila genset tidak digunakan harga sewa tetap berlaku.\r\nHarga sudah termasuk BBM untuk sewa harian. Sedangkan untuk sewa bulanan harga belum termasuk BBM', 'Barang', 'Dekorasi', 'Furniture', 0),
(4, 43, 'Kualitas sama dengan GoPro (boleh searching di youtube / google: perbedaan xiaomiyi dan gopro)\r\nAccesoris Lengkap\r\nSyarat Mudah\r\nHarga Murah', 'Booking hubungi CP\r\nMeninggalkan 2 kartu identitas', 'Barang', 'Elektronik', 'Kamera', 0);
...
(1, 'Muhammad Naufal Ferdiansyah', 'muhammad.nfl19@gmail.com', '7815696ecbf1c96e6894b779456d330e', '085704298419', 'Perumahan Taman Sidorejo Blok D-14 Krian', '2020-05-01', '1590157142-download.jpg', 1),
(2, 'Andrean', 'andreanilham9@gmail.com', 'andreanilham9', '085237216429', 'Benowo', '2020-04-20', 'default.png', 1),
(3, 'Artama', 'giopratama123456@gmail.com', 'gio123456', '0875326391662', 'Jakarta', '2020-04-16', 'default.png', 0),
(8, 'Budi', 'budi@gmail.com', '819ff8a2cb0ffdb89220fe06e1d352f6', NULL, NULL, '2020-05-22', 'default.png', 0),
(9, 'Joko', 'joko@gmail.com', '25d55ad283aa400af464c76d713c07ad', NULL, NULL, '2020-05-22', 'default.png', 0);
...
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `q_barang`  AS  select `tbl_barang`.`id_barang` AS `id_barang`,`tbl_barang`.`tipe_barang` AS `tipe_barang`,`tbl_barang`.`nama_barang` AS `nama_barang`,`tbl_barang`.`status_barang` AS `status_barang`,`tbl_barang`.`tgl_post_barang` AS `tgl_post_barang` from `tbl_barang` ;

-- --------------------------------------------------------

--
-- Structure for view `q_jual`
--
DROP TABLE IF EXISTS `q_jual`;

CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `q_jual`  AS  select `tbl_beli`.`id_barang` AS `id_barang`,`tbl_barang`.`tipe_barang` AS `tipe_barang`,`tbl_barang`.`nama_barang` AS `nama_barang`,`tbl_barang`.`desc_barang` AS `desc_barang`,`tbl_barang`.`tgl_post_barang` AS `tgl_post_barang`,`tbl_barang`.`status_barang` AS `status_barang`,`tbl_beli`.`harga_beli` AS `harga_beli`,`tbl_beli`.`status_beli` AS `status_beli`,`tbl_provinsi`.`name` AS `provinsi`,`tbl_kabupaten`.`name` AS `kabupaten`,`tbl_kecamatan`.`name` AS `kecamatan`,`tbl_user`.`id_user` AS `id_user`,`tbl_user`.`username` AS `username`,`tbl_user`.`email` AS `email`,`tbl_user`.`no_telp` AS `no_telp`,`tbl_user`.`tgl_daftar` AS `tgl_daftar`,`tbl_user`.`gambar_profile` AS `gambar_profile` from (`tbl_user` join (((((`tbl_barang` join `tbl_lokasi` on((`tbl_barang`.`id_barang` = `tbl_lokasi`.`id_barang`))) join `tbl_provinsi` on((`tbl_lokasi`.`id_provinsi` = `tbl_provinsi`.`id`))) join `tbl_kabupaten` on((`tbl_lokasi`.`id_kabupaten` = `tbl_kabupaten`.`id`))) join `tbl_kecamatan` on((`tbl_lokasi`.`id_kecamatan` = `tbl_kecamatan`.`id`))) join `tbl_beli` on((`tbl_barang`.`id_barang` = `tbl_beli`.`id_barang`))) on((`tbl_user`.`id_user` = `tbl_barang`.`id_user`))) ;

-- --------------------------------------------------------

--
-- Structure for view `q_sewa`
--
DROP TABLE IF EXISTS `q_sewa`;

CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `q_sewa`  AS  select `tbl_sewa`.`id_sewa` AS `id_sewa`,`tbl_sewa`.`id_barang` AS `id_barang`,`tbl_barang`.`tipe_barang` AS `tipe_barang`,`tbl_barang`.`nama_barang` AS `nama_barang`,`tbl_barang`.`desc_barang` AS `desc_barang`,`tbl_barang`.`tgl_post_barang` AS `tgl_post_barang`,`tbl_barang`.`status_barang` AS `status_barang`,`tbl_sewa`.`fasilitas_sewa` AS `fasilitas_sewa`,`tbl_sewa`.`syarat_sewa` AS `syarat_sewa`,`tbl_sewa`.`tipe_sewa` AS `tipe_sewa`,`tbl_sewa`.`kategori_sewa` AS `kategori_sewa`,`tbl_sewa`.`subkategori_sewa` AS `subkategori_sewa`,`tbl_sewa`.`status_sewa` AS `status_sewa`,`tbl_provinsi`.`name` AS `provinsi`,`tbl_kabupaten`.`name` AS `kabupaten`,`tbl_kecamatan`.`name` AS `kecamatan`,`tbl_user`.`id_user` AS `id_user`,`tbl_user`.`username` AS `username`,`tbl_user`.`email` AS `email`,`tbl_user`.`no_telp` AS `no_telp`,`tbl_user`.`tgl_daftar` AS `tgl_daftar`,`tbl_user`.`gambar_profile` AS `gambar_profile` from (`tbl_user` join (((((`tbl_barang` join `tbl_lokasi` on((`tbl_barang`.`id_barang` = `tbl_lokasi`.`id_barang`))) join `tbl_provinsi` on((`tbl_lokasi`.`id_provinsi` = `tbl_provinsi`.`id`))) join `tbl_kabupaten` on((`tbl_lokasi`.`id_kabupaten` = `tbl_kabupaten`.`id`))) join `tbl_kecamatan` on((`tbl_lokasi`.`id_kecamatan` = `tbl_kecamatan`.`id`))) join `tbl_sewa` on((`tbl_barang`.`id_barang` = `tbl_sewa`.`id_barang`))) on((`tbl_user`.`id_user` = `tbl_barang`.`id_user`))) ;
...
--
-- Indexes for table `tbl_elektronik`
--
ALTER TABLE `tbl_elektronik`
  ADD PRIMARY KEY (`id_elektronik`);

--
-- Indexes for table `tbl_gambar_list`
--
ALTER TABLE `tbl_gambar_list`
  ADD PRIMARY KEY (`id_gambar_list`);
...
--
-- AUTO_INCREMENT for table `tbl_elektronik`
--
ALTER TABLE `tbl_elektronik`
  MODIFY `id_elektronik` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;

--
-- AUTO_INCREMENT for table `tbl_gambar_list`
--
ALTER TABLE `tbl_gambar_list`
  MODIFY `id_gambar_list` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=64;
...
--
ALTER TABLE `tbl_kabupaten`
  ADD CONSTRAINT `regencies_province_id_foreign` FOREIGN KEY (`province_id`) REFERENCES `tbl_provinsi` (`id`);
COMMIT;
